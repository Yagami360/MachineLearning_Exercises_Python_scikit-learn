...
def main():
    ...
    print("classifier2 : Ramdom Forest1 ( purity = entropy, The number of trees in the forest = 5 )")
    # 誤分類のサンプル数を出力
    ...
    print("classifier3 : Ramdom Forest1 ( purity = entropy, The number of trees in the forest = 10 )")
    # 誤分類のサンプル数を出力
